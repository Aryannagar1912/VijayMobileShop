          ...
          loadingList.map((product, index) => {
            return (
              <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow">
                <div className="bg-slate-200 h-60 p-4 min-w-[280px] md:min-w-[145px] flex justify-center items-center animate-pulse">
                  
                </div>
                <div className="p-4 grid gap-3 w-full">
                  <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 text-black p-1 py-3 animate-pulse rounded-full bg-slate-200">
                    
                  </h2>
                  <p className="text-slate-500 p-1 py-2 rounded-full animate-pulse bg-slate-200"></p>
                  <div className="flex gap-3 w-full">
                    <p className="text-red-600 font-medium p-1 py-2 rounded-full animate-pulse bg-slate-200 w-full">
                      
                    </p>
                    <p className="text-slate-500 line-through p-1 py-2 rounded-full animate-pulse bg-slate-200 w-full">
                      
                    </p>
                  </div>
                  <button className="text-sm text-white px-3 rounded-full p-1 py-2 animate-pulse bg-slate-200">
            ...
            return (
              <Link to={"product/"+product?._id} className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-black rounded-sm shadow">
                ...
                <div className="p-4 grid gap-3">
                  ...
                  <p className="text-slate-500 invert">{product?.category}</p>
                  ...
                  <button className="text-sm bg-white hover:text-white hover:bg-gray-950 text-black px-3 py-0.5 rounded-full" onClick={(e) => handleAddToCart(e, product?._id)}>
                    Add to Cart
                  </button>
                </div>
              </Link>
