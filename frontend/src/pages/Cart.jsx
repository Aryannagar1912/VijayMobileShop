                        ...
                        loading ? (
                            loadingCart.map(el => {
                                ...
                                data.map((product, index) => {
                                    return (
                                        <div key={product?._id + "Add To Cart Loading"} className="w-full bg-black h-32 my-2 border border-white rounded grid grid-cols-[128px,1fr]">
                                            ...
                                            <div className="px-4 py-2 relative">
                                                ...
                                                <h2 className="text-lg lg:text-2xl text-ellipsis line-clamp-1 text-white">{product?.productId?.productName}</h2>
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    ...
                                                    <span className="text-white">{product?.productId?.quantity}</span>
